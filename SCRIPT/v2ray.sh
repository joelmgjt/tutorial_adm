...
source <(curl -sL https://raw.githubusercontent.com/rudi9999/tutorial_adm/master/ArchivosUtilitarios/V2RAY/install.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/rudi9999/tutorial_adm/master/ArchivosUtilitarios/V2RAY/install.sh) --remove
}
infocuenta () {
v2ray info
}
